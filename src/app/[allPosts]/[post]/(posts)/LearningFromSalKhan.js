...
<div className="d-flex justify-content-around mt-5"><Image alt="Time verses mastery image." style={{maxWidth: "400px", height: "auto"}} src={require('../../../../images/timeVmasteryT.png')}></Image></div>
...
<div className="d-flex justify-content-around mt-5"><Image alt="Mastery verses time image." style={{maxWidth: "400px", height: "auto"}} src={require('../../../../images/timeVmasteryM.png')}></Image></div>
